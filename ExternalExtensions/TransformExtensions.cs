// because the code depends on CoroutineWrapper
// if you wanted to you could provide a GameObject to the function to
// run the coroutine off of and remove the dependency
#if DT_CORE_MODULE
using System;
